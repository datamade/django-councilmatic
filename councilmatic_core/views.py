    ...
    def extra_context(self):
        ...
        if settings.USING_NOTIFICATIONS:
            ...
            if self.request.user.is_authenticated:
                ...
                search_params = {"term": search_term, "facets": selected_facets}

                try:
                    user.billsearchsubscriptions.get(
                        user=user, search_params__exact=search_params
                    )
...
class EventsView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if date_str:
            ...
            select_events = (
                Event.objects.filter(start_time__gt=date_time)
        ...
        # If no, then return upcoming events.
            ...
            upcoming_events = (
                Event.objects.filter(start_time__gt=timezone.now())
