...
class Command(BaseCommand):
    help = '''
        Overrides the Haystack rebuild_index command. 
        Assigns a value to DEFAULT_BATCH_SIZE. 
        https://github.com/django-haystack/django-haystack/blob/master/haystack/management/commands/update_index.py
    '''
